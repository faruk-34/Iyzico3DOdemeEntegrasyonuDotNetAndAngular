...
namespace Server.Controllers
{
    ...
    public class PaymentsController : ControllerBase
    {
        ...
        public async Task<IActionResult> Pay()
        {
            Options options = new()
            {
                ApiKey = "sandbox-GRmVVUfc69m7Uc84uActbcPQK32nxZpy",
                SecretKey = "sandbox-IsGVmXk4lEBjNsUi4ZkOpwAq0GHKlj4J",
            ...
            try
            {
                ...
                request.CallbackUrl = "https://localhost:7056/api/Payments/PayCallBack"; // 3D sonucunun döneceği URL
        ...
        public async Task<IActionResult> PayCallBack([FromForm] IFormCollection collections)
        {
            ...
            await _hubContext.Clients.Client(PayHub.TransationConnections[data.ConversationId]).SendAsync("Receive", data);
